              ...
              <Box
                ...
                <Accordion>
                  <AccordionSummary expandIcon={<ExpandMoreIcon />} aria-controls='panel1-content' id='panel1-header'>
                    <Typography component='span'>Basic information card</Typography>
                  </AccordionSummary>
                  <AccordionDetails>
                    <Typography gutterBottom>
                ...
                <Accordion>
                  <AccordionSummary expandIcon={<ExpandMoreIcon />} aria-controls='panel2-content' id='panel2-header'>
                    <Typography component='span'>Choghadiya card</Typography>
                  </AccordionSummary>
                  <AccordionDetails>
                    <Typography gutterBottom>
                      After calculating the sunrise by subtracting 96 minutes from the sunrise we calculate the <strong>Brahmamuhurta</strong> time lasting 48 minutes.
                ...
                <Accordion>
                  <AccordionSummary expandIcon={<ExpandMoreIcon />} aria-controls='panel3-content' id='panel3-header'>
                    <Typography component='span'>Swara card</Typography>
                  </AccordionSummary>
                  <AccordionDetails>
                    <Typography gutterBottom>
                    ...
                    <Typography gutterBottom>
                      <strong>
                        ...
                        While, conversely, during the first three days of “Krishna Pakṣa” (the dark fortnight), the Pingala flows first. (1st,2nd,3rd PINGLA, 4th 5th,6th IDA thus they
                        alternate).&quot;
                      </strong>
                    </Typography>
                    <Typography gutterBottom>
                      <strong>
                        &quot;In the bright fortnight, the lunar swara (Ida) rises from the time of sunrise and continues till the time span of two & a half Ghadis (60 minutes). In the dark fortnight,
                        the solar Swara (Pingala) rises first. So, these swaras flow alternately for a period of two-and-a half ghadis (60 minutes) throughout the twenty four hours of a day.&quot;
                      </strong>
                    </Typography>
                  </AccordionDetails>
                </Accordion>
                <Accordion>
                  <AccordionSummary expandIcon={<ExpandMoreIcon />} aria-controls='panel4-content' id='panel4-header'>
                    <Typography component='span'>Vrat card</Typography>
                  </AccordionSummary>
                  <AccordionDetails>
                    ...
                    <Typography gutterBottom>
                      ...
                      degrees on <strong>Shukla Pakṣa Ekadashi</strong> and in the range of 300-312 degrees on <strong>Kṛṣṇa Pakṣa Ekadashi</strong>. Therefore, Ēkādaśī is the eleventh lunar day
                      (tithi) in the waxing (Shukla Pakṣa) and waning (Kṛṣṇa Pakṣa) lunar cycle.
                    </Typography>
                  </AccordionDetails>
                </Accordion>
                <Accordion>
                  <AccordionSummary expandIcon={<ExpandMoreIcon />} aria-controls='panel5-content' id='panel5-header'>
                    <Typography component='span'>Panchang & calendar card</Typography>
                  </AccordionSummary>
                  <AccordionDetails>
                    <Typography gutterBottom>
                      After calculating the sunrise by subtracting 96 minutes from the sunrise we calculate the <strong>Brahmamuhurta</strong> time lasting 48 minutes.
