...
/* export default function Loader() {
  const text = "Sadhana Locating your position ..".split(" ");
  return (
    <div className='App'>
      {text.map((el, i) => (
        <motion.span
